...
var ConnectionList = require("./connection");
    ...
    if (message.type === "utf8") {
      ...
      if (typeof data.connectionName === "undefined") {
        ...
        if (typeof this.connections[data.connectionName] === "undefined") {
          this.connections[data.connectionName] = new ConnectionList();
        }
        this.connections[data.connectionName].addConnection(connection, key);
        console.log("connection " + key + " (" + data.connectionName + ") is ready.");
      }
    }
  });
...
WebSocketServer.prototype.getConnection = function(connectionName) {
  if (typeof this.connections[connectionName] === "undefined") {
    this.connections[connectionName] = new ConnectionList();
  }
